...
namespace MS.Castle.Logging.Log4Net
{
        ...
        ILogger
    {
        ...
        public void DebugFormat(System.Exception exception, IFormatProvider formatProvider, string format, params Object[] args)
        {
            if (IsDebugEnabled)
            {
        ...
        public void ErrorFormat(System.Exception exception, IFormatProvider formatProvider, string format, params Object[] args)
        {
            if (IsErrorEnabled)
            {
        ...
        public void FatalFormat(System.Exception exception, IFormatProvider formatProvider, string format, params Object[] args)
        {
            if (IsFatalEnabled)
            {
        ...
        public void InfoFormat(System.Exception exception, IFormatProvider formatProvider, string format, params Object[] args)
        {
            if (IsInfoEnabled)
            {
        ...
        public void WarnFormat(System.Exception exception, IFormatProvider formatProvider, string format, params Object[] args)
        {
            if (IsWarnEnabled)
            {
