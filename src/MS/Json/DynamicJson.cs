    ...
    public class DynamicJson : DynamicObject
    {
        ...
        private static JsonType GetJsonType(object obj)
        {
            ...
            switch (Type.GetTypeCode(obj.GetType()))
            {
                ...
                case TypeCode.Object:
                    return (obj is IEnumerable<object>) ? JsonType.array : JsonType.@object;
        ...
        private static object CreateJsonNode(object obj)
        {
            ...
            switch (type)
            {
                ...
                case JsonType.array:
                    return CreateXArray(obj as System.Collections.IEnumerable);
                case JsonType.@null:
                default:
                    return null;
            }
        ...
        private static IEnumerable<XStreamingElement> CreateXArray<T>(T obj) where T : System.Collections.IEnumerable
        {
